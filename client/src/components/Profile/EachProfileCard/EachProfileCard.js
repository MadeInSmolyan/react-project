...
const EachProfileCard = ({
    ...
    // console.log(id);
        ...
        <Link to={`/cars/edit/${id}`}><button className={styles.order_btn}>Edit Order</button></Link>
        <Link to={`/cars/delete/${id}`}><button className={styles.order_btn}>Cancel Order</button></Link>
        </article>
    </div>
}
